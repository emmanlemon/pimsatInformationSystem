<div class="modal fade" id="voluntariesModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{ url('employee/page/voluntary')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="hidden" name="employee_id" value="{{ session::get('loginId') }}" >

                  <div class="form-group">
                    <label>Address Organization:</label>
                    <input type="type" name="addr_organization" class="form-control" required>
                  </div>

                  <div class="form-group">
                    <label>Position:</label>
                    <input type="type" name="position" class="form-control" required>
                  </div>
